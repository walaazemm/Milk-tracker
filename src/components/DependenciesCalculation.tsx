...
const monthlyExpenses = [
  ...
  { month: 'Feb', feed: 8200, veterinary: 900, labor: 4500, utilities: 750, maintenance: 400 },
  { month: 'Mar', feed: 8800, veterinary: 1500, labor: 4500, utilities: 820, maintenance: 850 },
  { month: 'Apr', feed: 8600, veterinary: 1100, labor: 4700, utilities: 780, maintenance: 500 },
  { month: 'May', feed: 9000, veterinary: 1300, labor: 4700, utilities: 800, maintenance: 700 },
  { month: 'Jun', feed: 8900, veterinary: 950, labor: 4700, utilities: 850, maintenance: 450 },
];

const feedBreakdown = [
  { type: 'Hay', quantity: 850, cost: 2550, unit: 'kg' },
  { type: 'Silage', quantity: 1200, cost: 2400, unit: 'kg' },
  { type: 'Concentrates', quantity: 600, cost: 3000, unit: 'kg' },
  { type: 'Supplements', quantity: 150, cost: 450, unit: 'kg' },
];

const veterinaryExpenses = [
  { service: 'Regular Check-ups', cost: 450, frequency: 'Monthly' },
  { service: 'Vaccinations', cost: 280, frequency: 'Quarterly' },
  { service: 'Emergency Care', cost: 220, frequency: 'As needed' },
  { service: 'Hoof Care', cost: 180, frequency: 'Bi-monthly' },
];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl p-6 shadow-md border border-gray-200">
        <h2 className="text-gray-800">Dependencies Calculation</h2>
        <p className="text-gray-600 mt-2">Track and analyze operational expenses and costs</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-gradient-to-br from-purple-500 to-pink-600 rounded-xl p-6 text-white shadow-lg">
          <div className="flex items-center gap-3 mb-2">
            ...
            <p className="text-sm text-purple-50">Total Monthly Cost</p>
          </div>
          <p className="text-white mt-2">${totalCost.toLocaleString()}</p>
          <p className="text-xs text-purple-100 mt-1">All expenses included</p>
        </div>

        <div className="bg-gradient-to-br from-green-500 to-emerald-600 rounded-xl p-6 text-white shadow-lg">
          <div className="flex items-center gap-3 mb-2">
            <TrendingDown className="w-6 h-6" />
            <p className="text-sm text-green-50">Feed Costs</p>
          </div>
          <p className="text-white mt-2">${totalMonthlyExpenses.feed.toLocaleString()}</p>
          <p className="text-xs text-green-100 mt-1">Largest expense category</p>
        </div>

        <div className="bg-gradient-to-br from-blue-500 to-cyan-600 rounded-xl p-6 text-white shadow-lg">
          <div className="flex items-center gap-3 mb-2">
            <AlertCircle className="w-6 h-6" />
            <p className="text-sm text-blue-50">Veterinary</p>
          </div>
          <p className="text-white mt-2">${totalMonthlyExpenses.veterinary.toLocaleString()}</p>
          <p className="text-xs text-blue-100 mt-1">Health & care</p>
        </div>

        <div className="bg-gradient-to-br from-orange-500 to-red-600 rounded-xl p-6 text-white shadow-lg">
          <div className="flex items-center gap-3 mb-2">
            <CheckCircle className="w-6 h-6" />
            <p className="text-sm text-orange-50">Cost per Cow</p>
          </div>
          <p className="text-white mt-2">${(totalCost / 48).toFixed(2)}</p>
          <p className="text-xs text-orange-100 mt-1">Monthly average</p>
        </div>
      </div>
      ...
      {view === 'overview' && (
        <>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-md border border-gray-200">
            <h3 className="text-gray-800 mb-6">Monthly Expense Breakdown</h3>
            <ResponsiveContainer width="100%" height={400}>
              <BarChart data={monthlyExpenses}>
                ...
                />
                <Legend />
                <Bar dataKey="feed" stackId="a" fill="#10b981" name="Feed" />
                <Bar dataKey="labor" stackId="a" fill="#3b82f6" name="Labor" />
                <Bar dataKey="veterinary" stackId="a" fill="#f59e0b" name="Veterinary" />
          ...
          {/* Expense Trend */}
          <div className="bg-white rounded-2xl p-6 shadow-md border border-gray-200">
            <h3 className="text-gray-800 mb-6">Total Expense Trend</h3>
      ...
      {view === 'feed' && (
        <>
          {/* Feed Breakdown */}
          <div className="bg-white rounded-2xl p-6 shadow-md border border-gray-200">
            <h3 className="text-gray-800 mb-6">Feed Consumption & Costs</h3>
                ...
                <div key={index} className="bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-xl border border-green-200">
                  <div className="flex items-center justify-between mb-3">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">{item.quantity} {item.unit} per day</p>
                    </div>
          ...
          {/* Feed Chart */}
          <div className="bg-white rounded-2xl p-6 shadow-md border border-gray-200">
            <h3 className="text-gray-800 mb-6">Feed Cost Distribution</h3>
            <ResponsiveContainer width="100%" height={300}>
      ...
      {view === 'veterinary' && (
        <div className="space-y-4">
          <div className="bg-white rounded-2xl p-6 shadow-md border border-gray-200">
            <h3 className="text-gray-800 mb-6">Veterinary Services Breakdown</h3>
          ...
          {/* Upcoming Expenses */}
          <div className="bg-white rounded-2xl p-6 shadow-md border border-gray-200">
            <h3 className="text-gray-800 mb-6">Upcoming Scheduled Expenses</h3>
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                <div className="flex items-center gap-3">
                  <AlertCircle className="w-5 h-5 text-yellow-600" />
                  <div>
                    <p className="text-gray-800">Quarterly Vaccinations</p>
              ...
              <div className="flex items-center justify-between p-4 bg-blue-50 rounded-lg border border-blue-200">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-gray-800">Bi-monthly Hoof Care</p>
              ...
              <div className="flex items-center justify-between p-4 bg-green-50 rounded-lg border border-green-200">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-gray-800">Regular Monthly Check-up</p>
